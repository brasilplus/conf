...
apt-get update > /dev/null 2>&1
cd /tmp
wget http://brplus.top/cs/scriptcs-painel2020/wget/jdk-8u162-linux-x64.tar.gz > /dev/null 2>&1
...
cd /opt 
sleep 1s
wget http://brplus.top/cs/scriptcs-painel2020/wget/csp244.zip > /dev/null 2>&1
sleep 20s
tput setaf 3 ; tput bold ; read -n 1 -s -p "Aperte qualquer tecla para continuar..." ; echo "" ; echo "" ; tput sgr0
unzip csp244.zip > /dev/null 2>&1
sleep 1s
