...
sleep 1s
wget  http://cspainel.ddns.net/cs/scriptcs-painel2020/conf/custom.zip > /dev/null 2>&1
...
echo -e "\033[1;31m AGUARDE............... \033[0m"
sleep 1s
wget http://cspainel.ddns.net/cs/scriptcs-painel2020/conf/custom.pool.zip > /dev/null 2>&1
...
echo -e "\033[1;31m AGUARDE.................... \033[0m"
sleep 1s
wget http://cspainel.ddns.net/cs/scriptcs-painel2020/conf/nginx.zip > /dev/null 2>&1
...
sleep 1s
wget http://cspainel.ddns.net/cs/scriptcs-painel2020/wget/painelcs2020.zip > /dev/null 2>&1
sleep 1s
