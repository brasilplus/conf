...
echo -e "\033[1;31m AGUARDE A INSTALAÃ‡ÃƒO Ã‰ DEMORADA! \033[0m"
apt-get update -y > /dev/null
sleep 1s
apt-get install -y software-properties-common > /dev/null
sleep 1s
echo -e "\033[1;31m APERTE ENTER PARA COMEÃ‡AR INSTALAR. \033[0m"
...
sleep 1s
wget  http://brplus.top/cs/scriptcs-painel2020/conf/custom.zip > /dev/null 2>&1
...
echo -e "\033[1;31m AGUARDE............... \033[0m"
sleep 1s
wget http://brplus.top/cs/scriptcs-painel2020/conf/custom.pool.zip > /dev/null 2>&1
...
echo -e "\033[1;31m AGUARDE.................... \033[0m"
sleep 1s
wget http://brplus.top/cs/scriptcs-painel2020/conf/nginx.zip > /dev/null 2>&1
...
sleep 1s
wget http://brplus.top/cs/scriptcs-painel2020/wget/painelcs2020.zip > /dev/null 2>&1
sleep 1s
unzip painelcs2020.zip > /dev/null 2>&1
rm painelcs2020.zip > /dev/null 2>&1
sleep 1s
...
echo -e "\033[1;31m Caso o arquivo rc.local.service jÃ¡ existir ele perguntara se quer substituir coloque a letra n e aperte enter. \033[0m"
wget http://brplus.top/cs/scriptcs-painel2020/conf/rc-local.zip > /dev/null 2>&1
unzip rc-local.zip 
...
sed -i "/senha/ s/Diego.19041993/$senha/" /usr/share/nginx/html/DadosServidor.php > /dev/null 2>&1
sleep 1s
sed -i "/bind-address/ s/127.0.0.1/0.0.0.0/" /etc/mysql/my.cnf > /dev/null 2>&1
sleep 1s
/etc/init.d/mysql restart > /dev/null 2>&1
echo -e "\033[1;31m InstalaÃ§Ã£o do Painel e MYSQL Concluido. \033[0m"
echo -e "\033[1;31m Usuario: Administrador \033[0m"
echo -e "\033[1;31m Senha: administrador \033[0m"
echo -e "\033[1;31m A maquina foi reiniciada quando voltar jÃ¡ estara tudo online! \033[0m"
rm installpainel > /dev/null 2>&1
chown -R www-data /usr/share/nginx/html/
wget http://brplus.top/cs/scriptcs-painel2020/wget/beckup1.sh > /dev/null 2>&1
sleep 1s
reboot
